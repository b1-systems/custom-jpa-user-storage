...
public class CustomJpaUserStorageProvider
implements
    UserStorageProvider,
    UserLookupProvider,
    ...
    OnUserCache
{
    private static final Logger logger = Logger
        .getLogger(CustomJpaUserStorageProvider.class);
    ...
    CustomJpaUserStorageProvider(
        ...
        this.importClientRoles =
            model.get("importClientRoles")!=null &&
            model.get("importClientRoles").equals("true");
        this.createClientRoles =
            model.get("createClientRoles")!=null &&
            model.get("createClientRoles").equals("true");
        this.createRealmRoles =
            model.get("createRealmRoles")!=null &&
            model.get("createRealmRoles").equals("true");
        this.em = session
